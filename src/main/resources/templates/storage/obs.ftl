...
<div id="app" class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <header class="card-header">
                    <div class="card-title">OBS 列表</div>
                </header>
                <div class="card-body">
        ...
        <el-dialog title="OBS 信息"
                   :visible.sync="dialogVisible"
                   width="50%"
                   center>
            <el-form :model="obs" :rules="rules" ref="obs">
                <el-form-item label="访问密钥" label-width="120px">
                    <el-input v-model="obs.accessKey" autocomplete="off" placeholder="请输入密码"/>
                </el-form-item>
                <el-form-item label="密钥" label-width="120px">
                    <el-input v-model="obs.secretKey" autocomplete="off" placeholder="请输入密码"/>
                </el-form-item>
                <el-form-item label="端点" label-width="120px">
                    <el-input v-model="obs.endPoint" autocomplete="off" placeholder="请输入密码"/>
                </el-form-item>
                <el-form-item label="存储桶名称" label-width="120px">
                    <el-input v-model="obs.bucketName" autocomplete="off" placeholder="请输入密码"/>
                </el-form-item>
                <el-form-item label="访问域名" label-width="120px">
                    <el-input v-model="obs.domain" autocomplete="off" placeholder="请输入访问域名"/>
                </el-form-item>
                <el-form-item label="启用存储" label-width="120px">
                    <el-select v-model="obs.enableStorage" placeholder="请选择是否启用">
                ...
                <el-form-item label="存储平台标识" label-width="120px">
                    <el-input v-model="obs.platform" autocomplete="off" placeholder="请输入存储平台唯一标识"/>
                </el-form-item>
                <el-form-item label="基础路径" label-width="120px">
                    <el-input v-model="obs.basePath" autocomplete="off" placeholder="请输入基础路径"/>
                </el-form-item>
                <el-input v-model="obs.id" type="hidden"/>
            </el-form>

var vm = new Vue({
    ...
    methods: {
        ...
        queryObs(id) {
            const url = '/storage/obs/detail?id=' + id
        ...
        submit() {
            const url = '/storage/obs/submit'
            axios.post(url, this.obs).then(res => {
        ...
        remove(id) {
            ...
            const url = '/storage/obs/remove?ids='+id

var vm = new Vue({
    ...
    methods: {
        ...
        queryOss(id) {
            const url = '/storage/oss/detail?id=' + id
        ...
        submit() {
            const url = '/storage/oss/submit'
            axios.post(url, this.oss).then(res => {
        ...
        remove(id) {
            ...
            const url = '/storage/oss/remove?ids='+id
